...
const Imprint = () => {
    return (<div>
        <Header />
        <div className="container" style={{ margin: "auto", display: "block", marginTop: "60px", }}>
            <h2>Impressum</h2>
            ...
            Vetreten durch den Vorstand <br />

            Max Mustermann <br />
            <h5>Kontakt:</h5>

            Telefon: +49 1234 456789 <br />

            E-Mail: kleiderspenden@gmail.com <br />
            ...
            <h5>Hinweis auf die EU-Streitschlichtung:</h5>
